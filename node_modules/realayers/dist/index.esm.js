...
import { useState, useEffect, useRef, useCallback, forwardRef, Fragment, createContext, useMemo, createElement, useContext } from 'react';
import classNames from 'classnames';
import { ConnectedOverlay, useId, GlobalOverlay, CloneElement } from 'rdk';
...
const Tooltip = (_a) => {
    ...
    return (jsx(ConnectedOverlay, Object.assign({}, rest, { placement: placement, trigger: trigger, followCursor: followCursor, portalClassName: classNames({
            ...
            return (jsx(motion.div, Object.assign({ className: classNames(css.tooltip, className), initial: {
                    opacity: 0,
                    scale: 0.3,
                    transition: {
                        when: 'beforeChildren'
...
const Popover = (_a) => {
    ...
    const id = useId();
    return (jsx(Tooltip, Object.assign({}, rest, { trigger: trigger, pointerEvents: "initial", leaveDelay: leaveDelay, className: classNames(css$1.popover, {
            ...
            return (jsx(FocusTrap, Object.assign({ focusTrapOptions: {
                    escapeDeactivates: true,
                    clickOutsideDeactivates: true,
                    fallbackFocus: `#${id}`
                } }, { children: jsx("div", Object.assign({ id: id, "tab-index": "-1", stlye: popoverStyle, className: popoverClassName }, { children: children }), void 0) }), void 0));
        } }, { children: children }), void 0));
};
...
const DialogHeader = ({ children, className, showCloseButton, onClose }) => (jsxs("header", Object.assign({ className: classNames(css$2.header, className) }, { children: [jsx("h1", Object.assign({ className: css$2.headerText }, { children: children }), void 0),
        showCloseButton && (jsx("button", Object.assign({ type: "button", className: css$2.closeButton, onClick: onClose }, { children: "\u2715" }), void 0))] }), void 0));
...
const Dialog = ({ children, open, className, innerClassName, header, headerElement, footer, onClose, size, disablePadding, hasBackdrop, showCloseButton, closeOnBackdropClick, closeOnEscape }) => {
    const id = useId();
    return (jsx(GlobalOverlay, Object.assign({ open: open, hasBackdrop: hasBackdrop, closeOnEscape: closeOnEscape, closeOnBackdropClick: closeOnBackdropClick, onClose: onClose }, { children: ({ overlayIndex }) => (jsx(FocusTrap, Object.assign({ focusTrapOptions: {
                clickOutsideDeactivates: true,
                escapeDeactivates: true,
                fallbackFocus: `#${id}-content`
            } }, { children: jsx("div", Object.assign({ id: id, "tab-index": "-1" }, { children: jsx(motion.div, Object.assign({ initial: { opacity: 0, y: '-20%' }, animate: { opacity: 1, y: 0 }, exit: { opacity: 0, y: '20%' }, transition: { duration: 0.5, ease: [0.04, 0.62, 0.23, 0.98] }, style: { zIndex: overlayIndex }, className: classNames(css$2.dialog, className, {
                        [css$2.disableHeader]: !header,
                        [css$2.disablePadding]: disablePadding
                    }) }, { children: jsxs("div", Object.assign({ className: classNames(css$2.inner, innerClassName), style: { width: size } }, { children: [(header || headerElement) && (jsx(CloneElement, Object.assign({ element: headerElement, showCloseButton: showCloseButton, onClose: onClose }, { children: header }), void 0)),
                            jsx("section", Object.assign({ id: `${id}-content`, className: css$2.content }, { children: typeof children === 'function' ? children() : children }), void 0),
                            footer && jsx("footer", Object.assign({ className: css$2.footer }, { children: footer }), void 0)] }), void 0) }), void 0) }), void 0) }), void 0)) }), void 0));
};
Dialog.defaultProps = {
    size: '50%',
    ...
    closeOnEscape: true,
    headerElement: jsx(DialogHeader, {}, void 0)
};
...
const useDialog = (prop) => {
    ...
    const Component = useCallback((props) => (jsx(Dialog, Object.assign({}, props, { open: internalOpen, onClose: onCloseInternal }), void 0)), [internalOpen, onCloseInternal]);
    return {
        isOpen: internalOpen,
...
const DrawerHeader = ({ children, className, showCloseButton, onClose }) => (jsxs("header", Object.assign({ className: classNames(css$3.header, className) }, { children: [jsx("h1", { children: children }, void 0),
        showCloseButton && (jsx("button", Object.assign({ type: "button", className: css$3.closeButton, onClick: onClose }, { children: "\u2715" }), void 0))] }), void 0));
...
const Drawer = ({ className, headerElement, children, open, backdropClassName, header, position, size, hasBackdrop, closeOnEscape, closeOnBackdropClick, disablePadding, showCloseButton, onClose }) => {
    ...
    return (jsx(GlobalOverlay, Object.assign({ open: open, hasBackdrop: hasBackdrop, closeOnEscape: closeOnEscape, closeOnBackdropClick: closeOnBackdropClick, onClose: onClose, backdropClassName: backdropClassName }, { children: ({ overlayIndex }) => (jsx(FocusTrap, Object.assign({ focusTrapOptions: {
                clickOutsideDeactivates: true,
                escapeDeactivates: true,
                fallbackFocus: `#${id}`
            } }, { children: jsx("div", Object.assign({ id: id, "tab-index": "-1" }, { children: jsxs(motion.div, Object.assign({ initial: "initial", animate: "animate", exit: "initial", variants: variant, transition: {
                        duration: 0.5,
                    ...
                    }) }, { children: [(header || headerElement) && (jsx(CloneElement, Object.assign({ element: headerElement, showCloseButton: showCloseButton, onClose: onClose }, { children: header }), void 0)),
                        !header && !headerElement && showCloseButton && (jsx("button", Object.assign({ type: "button", className: classNames(css$3.closeButton, css$3.headerlessCloseButton), onClick: onClose }, { children: "\u2715" }), void 0)),
                        jsx("div", Object.assign({ className: css$3.content }, { children: typeof children === 'function' ? children() : children }), void 0)] }), void 0) }), void 0) }), void 0)) }), void 0));
};
Drawer.defaultProps = {
    position: 'end',
    size: '80%',
    ...
    disablePadding: false,
    showCloseButton: true,
    headerElement: jsx(DrawerHeader, {}, void 0)
};
...
const useDrawer = (prop) => {
    ...
    const Component = useCallback((props) => (jsx(Drawer, Object.assign({}, props, { open: internalOpen, onClose: onCloseInternal }), void 0)), [internalOpen, onCloseInternal]);
    return {
        isOpen: internalOpen,
        setOpen: setInternalOpen,
        toggleOpen: onToggleOpen,
...
const Menu = forwardRef(({ reference, children, style, className, placement, closeOnEscape, open, appendToBody, closeOnBodyClick, maxHeight, autofocus, onClose, onMouseEnter, onMouseLeave }, ref) => {
    const id = useId();
    return (jsx(ConnectedOverlay, { open: open, closeOnBodyClick: closeOnBodyClick, appendToBody: appendToBody, reference: reference, placement: placement, closeOnEscape: closeOnEscape, content: () => (jsxs(motion.div, Object.assign({ ref: ref, initial: { opacity: 0, y: -10 }, animate: { opacity: 1, y: 0 }, exit: { opacity: 0, y: -10 }, className: classNames(css$4.container, className), style: style, onMouseEnter: onMouseEnter, onMouseLeave: onMouseLeave }, { children: [autofocus && (jsx(FocusTrap, Object.assign({ focusTrapOptions: {
                        escapeDeactivates: true,
                        clickOutsideDeactivates: true,
                        fallbackFocus: `#${id}`
                    } }, { children: jsx("div", Object.assign({ id: id, className: css$4.inner, tabIndex: -1, style: { maxHeight } }, { children: children }), void 0) }), void 0)),
                !autofocus && jsx("div", Object.assign({ className: css$4.inner }, { children: children }), void 0)] }), void 0)), onClose: onClose }, void 0));
});
Menu.defaultProps = {
...
const useMenu = (prop) => {
    ...
    const Component = useCallback((props) => (jsx(Menu, Object.assign({}, props, { open: internalOpen, reference: ref, onClose: onCloseInternal }), void 0)), [internalOpen, onCloseInternal]);
    return {
        isOpen: internalOpen,
        setOpen: setInternalOpen,
        toggleOpen: onToggleOpen,
...
const NestedMenu = ({ label, children, style, placement, menuClassName, menuStyle, enterDelay, autofocus, leaveDelay, className, maxHeight, activeClassName, closeOnBodyClick, closeOnEscape, onClose }) => {
    ...
    const onMouseLeaveMenu = useCallback(event => {
        clearTimeout(enterTimeoutRef.current);
        clearTimeout(leaveTimeoutRef.current);
    ...
    const onNestedMenuClose = useCallback(event => {
        setActive(false);
        onClose === null || onClose === void 0 ? void 0 : onClose(event);
    }, [onClose]);
    return (jsxs(Fragment, { children: [jsx("div", Object.assign({ className: classNames(className, { [activeClassName]: active }), style: style, ref: itemRef, onClick: onClickItem, onMouseEnter: onMouseEnterItem, onMouseLeave: onMouseLeaveItem }, { children: label }), void 0),
...
const ContextMenu = (_a) => {
    ...
    return (jsx(ConnectedOverlay, Object.assign({ placement: "bottom-start", triggerElement: "span" }, rest, { triggerClassName: classNames({
            [css$5.open]: open,
            [css$5.enabled]: !disabled
        }), trigger: "contextmenu", open: open, content: () => (jsxs(motion.div, Object.assign({ initial: { opacity: 0, y: -25 }, animate: { opacity: 1, y: 0 }, exit: { opacity: 0, y: -25 }, onClick: () => autoClose && (onClose === null || onClose === void 0 ? void 0 : onClose()) }, { children: [autofocus && (jsx(FocusTrap, Object.assign({ focusTrapOptions: {
                        escapeDeactivates: true,
                        clickOutsideDeactivates: true,
                        fallbackFocus: `#${id}`
                    } }, { children: jsx("div", Object.assign({ id: id, tabIndex: -1 }, { children: content }), void 0) }), void 0)), !autofocus && content] }), void 0)), onOpen: onOpen, onClose: onClose }, { children: children }), void 0));
};
...
const Notification = ({ id, title, showClose, body, timeout, className, variant, onClose }) => {
    ...
    return (jsxs(motion.div, Object.assign({ layout: true, initial: { opacity: 0, y: 50, scale: 0.5 }, animate: { opacity: 1, y: 0, scale: 1 }, exit: { opacity: 0, scale: 0.5, transition: { duration: 0.2 } }, className: classNames(css$6.notification, className, {
            [css$6.default]: variant === 'default',
            [css$6.error]: variant === 'error',
            [css$6.success]: variant === 'success',
            [css$6.warning]: variant === 'warning'
        }), onMouseEnter: clearTimer, onMouseLeave: startTimer }, { children: [jsxs("div", Object.assign({ className: css$6.content }, { children: [title && jsx("div", Object.assign({ className: css$6.header }, { children: title }), void 0),
                    body && (jsx("div", Object.assign({ className: css$6.body }, { children: typeof body === 'string' ? (jsx("span", { dangerouslySetInnerHTML: { __html: body } }, void 0)) : (body) }), void 0))] }), void 0),
            jsx("div", Object.assign({ className: css$6.close }, { children: showClose && (jsx("button", Object.assign({ type: "button", className: css$6.closeButton, variant: "text", onClick: () => onClose === null || onClose === void 0 ? void 0 : onClose(id) }, { children: "\u2715" }), void 0)) }), void 0)] }), void 0));
};
...
const Notifications = ({ children, limit, timeout, showClose, preventFlooding }) => {
    ...
    const clearNotification = useCallback((id) => setNotifications(notifications.filter(n => n.id !== id)), [notifications]);
    ...
    const notifyError = useCallback((title, options = {}) => notify(title, Object.assign(Object.assign({}, options), { variant: 'error' })), [notify]);
    const notifyWarning = useCallback((title, options = {}) => notify(title, Object.assign(Object.assign({}, options), { variant: 'warning' })), [notify]);
    const notifySuccess = useCallback((title, options = {}) => notify(title, Object.assign(Object.assign({}, options), { variant: 'success' })), [notify]);
    ...
    return (jsxs(Fragment, { children: [jsx(NotificationsContext.Provider, Object.assign({ value: values }, { children: children }), void 0),
            jsx("div", Object.assign({ className: css$7.container }, { children: jsx("div", Object.assign({ className: css$7.positions }, { children: jsx(AnimatePresence, { children: !!notifications.length && (jsx(motion.div, Object.assign({ initial: { opacity: 0 }, animate: { opacity: 1 }, exit: { opacity: 0 } }, { children: notifications.map(n => (createElement(Notification, Object.assign({}, n, { key: n.id, onClose: clearNotification })))) }), void 0)) }, void 0) }), void 0) }), void 0)] }, void 0));
};
...
export { ContextMenu, Dialog, DialogHeader, Drawer, DrawerHeader, Menu, NestedMenu, Notifications, NotificationsContext, Popover, Tooltip, useDialog, useDrawer, useMenu, useNotification, useTooltipState };
